<%@ Page Title="" Language="C#" MasterPageFile="~/loggedinnavbar.Master" AutoEventWireup="true" CodeFile="CryptoList.aspx.cs" Inherits="BIPJ_sharedcopy1.CryptoList" %>
    ...
    <main id="main" class="main">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <asp:DataList ID="DataList2" runat="server" DataKeyField="TokenID" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
                    <ItemTemplate>
...
<br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:usersContext %>" SelectCommand="SELECT [TokenID], [Rank], [Icon] FROM [Tokens]"></asp:SqlDataSource>
            </div><!-- Luna -->
