<%@ Page Title="" Language="C#" MasterPageFile="~/loggedinnavbar.Master" AutoEventWireup="true" CodeBehind="pooldeposit.aspx.cs" Inherits="BIPJ_sharedcopy1.pooldeposit" %>
...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
    ...
    <body>                
        <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="index.aspx">Home</a></li><li class="breadcrumb-item active"><a href="wallet.aspx">Wallet</a></li><li class="breadcrumb-item active">Pool deposit</li></ol></nav>
